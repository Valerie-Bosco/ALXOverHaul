...
bl_info = {
    "name": "ALXOverHaul",
    "author": "Valerie Bosco[House Arhal]",
    "description": "",
    "warning": "",
    "version": (1, 0, 0),
    "blender": (4, 0, 0),
...
def RegisterProperties():
    ...
    # region weightpaint bucket fill
...
def RegisterHandlers():
    bpy.app.handlers.load_post.append(ALX_Handlers.AlxMain_load_post)
    bpy.app.handlers.save_post.append(ALX_Handlers.ALX_MainSavePost)

    bpy.app.handlers.load_post.append(ALX_Handlers.AlxAddonKeymapHandler)
    bpy.app.handlers.load_post.append(ALX_Handlers.AlxUpdateSceneSelectionObjectList)
...
def UnRegisterHandlers():
    bpy.app.handlers.load_post.remove(ALX_Handlers.AlxMain_load_post)
    bpy.app.handlers.save_post.remove(ALX_Handlers.ALX_MainSavePost)

    bpy.app.handlers.load_post.remove(ALX_Handlers.AlxAddonKeymapHandler)
    bpy.app.handlers.load_post.remove(ALX_Handlers.AlxUpdateSceneSelectionObjectList)
