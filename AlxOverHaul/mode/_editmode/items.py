...
focus_levels_items = [("SINGLE", "Single", ""), ("MULTIPLE", "Multiple", "")]

align_mode_items = [("VIEW", "View", ""), ("AXES", "Axes", "")]
...
driver_space_items = [
    (
        "AUTO",
        "Auto",
        "Choose Local or World space based on whether driver object is parented",
    ),
    ("LOCAL_SPACE", "Local", ""),
    ("WORLD_SPACE", "World", ""),
]
...
cursor_spin_angle_preset_items = [
    ("None", "None", ""),
    ("30", "30", ""),
    ("45", "45", ""),
    ("60", "60", ""),
...
create_assembly_asset_empty_location_items = [
    ("AVG", "Average", ""),
    ("AVGFLOOR", "Average Floor", ""),
    ("WORLDORIGIN", "World Origin", ""),
]

create_assembly_asset_empty_collection_items = [
    ("SCENECOL", "Add to Scene Collection", ""),
    ("OBJCOLS", "Add to Object Collections", ""),
]

shade_mode_items = [("SMOOTH", "Smooth", ""), ("FLAT", "Flat", "")]
...
render_engine_items = [("BLENDER_EEVEE", "Eevee", ""), ("CYCLES", "Cycles", "")]
...
cycles_device_items = [("CPU", "CPU", ""), ("GPU", "GPU", "")]
...
bc_orientation_items = [
    ("LOCAL", "Local", ""),
    ("NEAREST", "Nearest", ""),
    ("LONGEST", "Longest", ""),
]

tool_name_mapping_dict = {
    "BC": "BoxCutter",
    "Hops": "HardOps",
